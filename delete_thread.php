...
$sql1="delete from tb_comment where idthread='$id'";
$sql2="delete from tb_likethread where idthread='$id'";
$sql3="delete from tb_likecomment where idthread='$id'";
...
?>
    <script type="text/javascript">
      ...
      swal("Thread Berhasil Dihapus!", "", "success")
        .then((value) => {
