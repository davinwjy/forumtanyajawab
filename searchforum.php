...
<div id="background" style="padding-top: 50px;">
  ...
  <?php
  include "koneksi.php";
  $inputsearch=$_POST['searchkategori'];
  $idmatpel1=$_GET['idmatpel'];
  $sql="select * from tb_thread where idmatpel='$idmatpel1' AND (judul LIKE '%$inputsearch%' or isi LIKE '%$inputsearch%')";
  ...
  <div class="container" style="padding-top: 60px;">
    <div class="row">
      ...
      <div class="col-sm-8" style="padding-bottom: 50px">
          <h3><font color="white">
              <?php
              echo "Menampilkan thread untuk '".$inputsearch."'";
              ?>
          </font></h3>
          <div class="row">
    ...
    <tbody> 
      ...
      <td colspan="3"> 
          <font color="black"><b>
                ...
                <h3>
                  <p>
                      Hasil Pencarian <?php echo "'".$inputsearch."' tidak dapat ditemukan"; ?>
                </h2>
                </center>
          </b></font>
      </td>
