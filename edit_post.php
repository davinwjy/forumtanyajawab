                  ...
                  <div class="col-sm-12">
                    <form method="POST">
                      <div class="form-group">                        
                        ...
                        $idthread1=$_GET['idthread'];
                        $sqledit="select * from tb_thread where id='$idthread1'";
                        $queryedit=mysqli_query($mysqli,$sqledit);
                        $rowedit=mysqli_fetch_assoc($queryedit);
                        while($row=mysqli_fetch_array($mysqlimatpel)){
                        ?>
                          <option value="<?php echo $row["id"]; ?>" <?php if($row['namamatpel']===$hasil['namamatpel']) echo 'selected="selected"';?> disabled>
                        ...
                        <input type="text" class="form-control" id="judul" name="judul" maxlength="255" required="required" value="<?php echo $rowedit['judul']; ?>">
                        <br>                     
...
if ($_SERVER['REQUEST_METHOD']=='POST'){
  ...
  $sql = "update tb_thread set judul='$judul',isi='$isi'
  where id='$idthread2'";
...
<script type="text/javascript">
  ...
  swal("Thread Berhasil Diedit!", "", "success")
    .then((value) => {
